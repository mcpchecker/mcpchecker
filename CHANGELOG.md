...
### Fixed
- Deduplicate tasks when multiple globs or paths match the same file (using canonical path resolution), evaluating all assertions from matching TaskSets independently
